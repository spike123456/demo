...
function addNewToCart() {
	showToast("error","Lỗi","Hệ thống đặt hàng đang tạm ngưng hoạt động trong giai đoạn tết nguyên đán. Đối với những khách hàng tại TP.HCM, xin vui lòng liên lạc với shop qua webchat để có thêm thông tin giao hàng. Xin cảm ơn quý khách.");
	// if (isOverSell()) {
	// 	if (extra) {
